...
func start(c *cli.Context) {
	...
	tracer, closer, err := cfg.New(
		...
		config.Observer(rpcmetrics.NewObserver(metrics.Namespace("part", nil), rpcmetrics.DefaultNameNormalizer)),
	)
	if err != nil {
	...
	// Create Table from Part struct generated by gRPC
	db.CreateTable(&api.Part{}, nil)

	// Register Part service, prometheus and HTTP service handler
	api.RegisterPartServiceServer(server, &part.Service{DB: db})
	...
	log.Println("Starting Part service..")
	go server.Serve(lis)
